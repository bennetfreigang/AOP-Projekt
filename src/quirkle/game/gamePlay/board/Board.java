...
public class Board {
    ...
    public Tile getTileAt(Position position) {
        Tile placedTile = placedTiles.get(position);
    ...
    /**
     * Stages multiple tiles at once
     *
     * @throws IllegalStateException if the pending tiles would be illegal with {@code tiles} added
     */
